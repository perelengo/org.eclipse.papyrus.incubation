...
public class CreateLayerOperatorsFromParameter extends AbstractLayersCommand {
	 ...
	 *
	 * @see org.eclipse.papyrus.infra.gmfdiag.layers.ui.commands.AbstractLayersCommand#preExecute(org.eclipse.core.commands.ExecutionEvent, org.eclipse.core.expressions.IEvaluationContext, java.util.List)
	 *
	 * @param event
	 * @param context
	 * @param selections
	...
	protected boolean preExecute(ExecutionEvent event, IEvaluationContext context, List<Object> selections) throws ExecutionException {
		...
		newLayerID = event.getParameter("org.eclipse.papyrus.infra.gmfdiag.layers.ui.createLayerOperator.parameters");
	...
	/**
	 *
	 * @see org.eclipse.papyrus.infra.gmfdiag.layers.ui.commands.AbstractLayersCommand#getCommandName()
	 *
	 * @return
	 */
	@Override
