...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.layers.LayerNamedStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class LayerNamedStyleItemProvider extends NamedStyleItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LayerNamedStyle")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_LayerNamedStyle_type") : //$NON-NLS-1$
				getString("_UI_LayerNamedStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
