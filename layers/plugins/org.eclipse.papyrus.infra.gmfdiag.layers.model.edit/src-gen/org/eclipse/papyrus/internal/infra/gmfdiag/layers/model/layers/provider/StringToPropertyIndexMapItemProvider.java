...
public class StringToPropertyIndexMapItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringToPropertyIndexMap_key_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StringToPropertyIndexMap_key_feature", "_UI_StringToPropertyIndexMap_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StringToPropertyIndexMap")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return "" + stringToPropertyIndexMap.getKey() + " -> " + stringToPropertyIndexMap.getValue(); //$NON-NLS-1$ //$NON-NLS-2$
	}
