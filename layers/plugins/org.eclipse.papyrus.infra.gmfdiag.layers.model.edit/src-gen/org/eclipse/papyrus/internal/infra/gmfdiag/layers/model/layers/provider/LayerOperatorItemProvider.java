...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.layers.LayerOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerOperatorItemProvider extends LayerExpressionItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_LayerOperator_type") : //$NON-NLS-1$
			getString("_UI_LayerOperator_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
