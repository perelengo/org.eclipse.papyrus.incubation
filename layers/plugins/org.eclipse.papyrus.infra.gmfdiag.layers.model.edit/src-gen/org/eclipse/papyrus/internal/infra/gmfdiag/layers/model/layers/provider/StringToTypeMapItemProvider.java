...
public class StringToTypeMapItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringToTypeMap_key_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StringToTypeMap_key_feature", "_UI_StringToTypeMap_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StringToTypeMap")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return "" + stringToTypeMap.getKey() + " -> " + stringToTypeMap.getValue(); //$NON-NLS-1$ //$NON-NLS-2$
	}
