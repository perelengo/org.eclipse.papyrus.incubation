...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.layers.PropertyRegistry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyRegistryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyRegistry_propertiesCount_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyRegistry_propertiesCount_feature", "_UI_PropertyRegistry_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PropertyRegistry")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_PropertyRegistry_type") + " " + propertyRegistry.getPropertiesCount(); //$NON-NLS-1$ //$NON-NLS-2$
	}
