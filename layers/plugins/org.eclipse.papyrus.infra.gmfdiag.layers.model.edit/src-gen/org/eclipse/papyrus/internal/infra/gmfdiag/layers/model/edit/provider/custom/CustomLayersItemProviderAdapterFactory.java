 ...
 ******************************************************************************/
package org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.edit.provider.custom;

import org.eclipse.emf.common.notify.Adapter;
import org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.edit.provider.LayersItemProviderAdapterFactory;
	...
	public Adapter createLayerAdapter() {
		if (layerItemProvider == null) {
			layerItemProvider = new LayerItemProvider(this,
					(org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.edit.provider.LayerItemProvider) super.createLayerAdapter());
		}
	...
	public Adapter createRegExpLayerAdapter() {
		if (regExpLayerItemProvider == null) {
			regExpLayerItemProvider = new RegExpLayerItemProvider(this,
					(org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.edit.provider.RegExpLayerItemProvider) super.createRegExpLayerAdapter());
		}
	...
	public Adapter createAllViewsDerivedLayerAdapter() {
		if (allViewsDerivedLayerItemProvider == null) {
			allViewsDerivedLayerItemProvider = new AllViewsDerivedLayerItemProvider(this,
					(org.eclipse.papyrus.internal.infra.gmfdiag.layers.model.edit.provider.AllViewsDerivedLayerItemProvider) super.createAllViewsDerivedLayerAdapter());
		}
