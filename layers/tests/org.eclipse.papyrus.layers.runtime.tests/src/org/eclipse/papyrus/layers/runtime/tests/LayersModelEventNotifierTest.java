...
public class LayersModelEventNotifierTest {
	...
	public void testAddLayersModelEventListener() {
		...
		// Check creation
		assertNotNull("notifier created", notifier);
		assertTrue("listener added to internal list", notifier.getListeners().contains(listener));
	}
	...
	public void testRemoveLayersModelEventListener() {
		...
		assertFalse("listener removed from internal list", notifier.getListeners().contains(listener));
