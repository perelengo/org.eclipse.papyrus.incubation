...
public class LayerStackApplicationSynchronizerSubclass extends LayerStackApplicationSynchronizer {
	 ...
	 * @param notationModel
	 */
	public LayerStackApplicationSynchronizerSubclass(LayersModelResource layersModel, NotationModel notationModel) {
	 ...
	 * @param traces
	 */
	public LayerStackApplicationSynchronizerSubclass(LayersModelResource layersModel, NotationModel notationModel, TriggeredEventTraces traces) {
		super(layersModel, notationModel);
		this.traces = traces;
	}
