...
package org.eclipse.papyrus.layers.integration.tests;
...
public class LayersStateAfterReloadTest {
	 ...
	 */
	final protected String PLUGIN_PROJECT_NAME = "org.eclipse.papyrus.layers.integration.tests.tests";

	/**
	 * Name of the bundle containing resources to copied.
	 */
	final protected String BUNDLE_NAME = "org.eclipse.papyrus.layers.integration.tests";
