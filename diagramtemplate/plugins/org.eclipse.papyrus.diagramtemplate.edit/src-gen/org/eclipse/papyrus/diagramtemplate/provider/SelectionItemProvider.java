...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.diagramtemplate.Selection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class SelectionItemProvider extends AbstractSelectionItemProvider {
	// The class in the orginal code base also implements: IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
	/**
	...
	protected void addRecursivelyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Selection_recursively_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Selection_recursively_feature", "_UI_Selection_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Selection")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Selection_type") : //$NON-NLS-1$
				getString("_UI_Selection_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
