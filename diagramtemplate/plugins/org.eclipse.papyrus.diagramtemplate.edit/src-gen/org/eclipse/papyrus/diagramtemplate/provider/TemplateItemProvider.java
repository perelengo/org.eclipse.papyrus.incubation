...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.diagramtemplate.Template} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class TemplateItemProvider
	...
	protected void addTargetRootPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Template_targetRoot_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Template_targetRoot_feature", "_UI_Template_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public String getText(Object object) {
		return getString("_UI_Template_type"); //$NON-NLS-1$
	}
